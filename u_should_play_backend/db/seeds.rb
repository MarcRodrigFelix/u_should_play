...
Comment.create(content: "Mario cheats Hot Coffee mode real time Metroid Prime shovelware Tony Hawk's exploit controller.", commentator: "RedsBrotha", game_id: red.id)
Comment.create(content: "Tetris time attack NBA Live boss quickscope smart bomb Sega Genesis.", commentator: "UncleTommy", game_id: last.id)
Comment.create(content: "Casual Flying Simulator Mega Man Bullet Hell AI The Witcher class Platform Game Pwn.", commentator: "nottAffan", game_id: furi.id)